...
export default function Navbar() {
    ...
    return (
        //  <nav className='fixed top-0 z-50 w-full bg-gray-500  border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700'>
        <nav className="MyNavbar py-2 z-50 w-full bg-gray-400 border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div className="px-3 lg:px-5 lg:pl-3">
                <div className="flex items-center justify-between">
                    <div className=" flex items-center justify-start">
                        <a href="/" className="flex ml-2 md:mr-24">
                            <img src={logo} className="h-8 mr-3" alt="Computer Department logo" />
                            <span className="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">Computer Department</span>
                        </a>
                    </div>
                    <div className="flex items-center">
                        <div className="flex items-center ml-3 space-x-4">
                            ...
                            <div className=''>
                                <button title="Profile" type="button" onClick={() => { openUserProfile(); }} className=" flex text-sm bg-transparent rounded-full focus:ring-1 focus:ring-gray-300 dark:focus:ring-gray-600" >
