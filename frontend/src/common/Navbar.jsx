...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="MyNavbar py-2 z-50 w-full bg-gray-400 dark:bg-slate-950 border-b border-gray-200  dark:border-gray-700">
            ...
            <div className="flex items-center ml-3 space-x-4">
              <div className="">
                <button
                  ...
                  title="Settings"
                  onClick={() => {
                    openCommonSettingPage();
                  }}
                  className="px-2 flex text-sm text-dark dark:text-white rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
                >
                  <svg
                  ...
                  >
                    <path
                      className="fill-current text-black dark:text-sky-800"
              ...
              <div className="">
                <button
                  ...
                  className=" flex text-sm bg-transparent rounded-full focus:ring-1 focus:ring-gray-300 dark:focus:ring-gray-600"
                >
                  <img
