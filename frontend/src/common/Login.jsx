...
export function Login() {
  ...
  function handleLogin() {
    ...
    loginPromise
      ...
      .catch((message) => {
        ...
        if (
          message ==
          "Verification email is already send, please verify your email by click on the given Link in Mail"
        ) {
  ...
  function handleRegister() {
    ...
    toast.promise(
      registerPromise,
      {
        ...
        success: (data) => {
          return "Registerd Successfully, please go to your inbox and verify your email to proceed further";
        },
        error: (err) => err,
      },
      {
  ...
  function resendVerificationLink() {
    ...
    const resendEmailVerificationLinkPromise =
      authService.resendVerificationLink(cred);
    toast.promise(
      ...
      {isLogin ? (
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6">
            <h5 className="text-xl font-medium text-gray-900 dark:text-white">
              log in to Department management system{" "}
            </h5>
            <div>
              <label
                htmlFor="email"
            ...
            {resendEnable ? (
              <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                resend verification link expired?{" "}
                <a
                  onClick={() => {
        ...
        <div className="w-full max-w-sm p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
          <form className="space-y-6" action="#">
            <h5 className="text-xl font-medium text-gray-900 dark:text-white">
              Sign up to Department management system
            </h5>
            <div>
              <label
                htmlFor="email"
