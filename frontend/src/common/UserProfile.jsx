...
export const UserProfile = ({ readOnly }) => {
  ...
  return (
    <div className="">
      ...
      {userProfile ? (
        <div
          className={`flex px-2 flex-col mt-5 ${
            readOnly ? "" : "shadow-md sm:rounded-lg"
          }`}
        >
          ...
          <div className="m-1 p-5 flex flex-col ">
            <div className="mb-12 w-48 h-auto mt-2 mx-auto ">
              <img
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              <div className="w-full mb-6">
                ...
                <p className="text-sm text-gray-900 dark:text-white">
                  {userProfile.personalDetails.mobileNo}
                </p>
              </div>
              <div className="w-full mb-6">
                <p className="text-sm font-medium text-gray-500 dark:text-gray-400">
                ...
                <p className="text-sm text-gray-900 dark:text-white">
                  {userProfile.personalDetails.employeeId}
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="w-full mb-6">
                ...
                <p className="text-sm text-gray-900 dark:text-white">
                  {userProfile.bankDetails.branch}
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 md:gap-6">
              ...
              <div className="w-full mb-6">
                ...
                <p className="text-sm text-gray-900 dark:text-white">
                  {formatDateToDdMmYyyy(String(userProfile.joiningDate))}
                </p>
              </div>
            </div>
        ...
        <div
          className={`flex flex-col m-3 p-3 ${
            readOnly ? "" : "shadow-md sm:rounded-lg"
          }`}
        >
          <h3 className="text-3xl mx-auto font-medium text-red-900 dark:text-white">
            {readOnly
              ? "Profile details is not filled up by user"
