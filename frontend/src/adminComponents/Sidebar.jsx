...
export default function Sidebar() {
  ...
  return (
    <aside
      id="AppSideBar"
      className="AppSideBar  w-64 h-screen pt-3 transition-transform -translate-x-full bg-gray-300 border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
      aria-label="Sidebar"
    >
