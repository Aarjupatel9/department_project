...
class GuideService {
  addGuide(data) {
    return new Promise(function (resolve, reject) {
      ...
      fetch(
        process.env.REACT_APP_API_SERVER + "/api/guide/addGuide",
        fetchPostOptions
      )
        .then((response) => {
  ...
  updateGuide(_id, data) {
    return new Promise(function (resolve, reject) {
      fetchPostOptions.body = JSON.stringify(data);
      fetch(
        process.env.REACT_APP_API_SERVER +
          "/api/guide/updateGuide/" +
          _id,
        fetchPostOptions
      )
        .then((response) => {
  ...
  getGuides() {
    return new Promise(function (resolve, reject) {
      fetch(
        process.env.REACT_APP_API_SERVER + "/api/guide/guides",
        fetchPostOptions
      )
        .then((response) => {
          console.log("fetch then response :", response);
