...
class UserService {
  addPatent(data) {
    return new Promise(function (resolve, reject) {
      ...
      fetch(
        process.env.REACT_APP_API_SERVER + "/api/patent/addPatent",
        fetchPostOptions
      )
        .then((response) => {
  ...
  updatePatent(_id, data) {
    return new Promise(function (resolve, reject) {
      fetchPostOptions.body = JSON.stringify(data);
      fetch(
        process.env.REACT_APP_API_SERVER +
          "/api/patent/updatePatent/" +
          _id,
        fetchPostOptions
      )
        .then((response) => {
  ...
  getPatents() {
    return new Promise(function (resolve, reject) {
      fetch(
        process.env.REACT_APP_API_SERVER + "/api/patent/getPatents",
        fetchPostOptions
      )
        .then((response) => {
          console.log("fetch then response :", response);
